  ...
  return (
    <MenuPrimitive.Portal>
      <MenuPrimitive.Positioner
        ...
        className="z-50 min-w-(--trigger-width)"
      >
        <MenuPrimitive.Popup
          className={cn(
